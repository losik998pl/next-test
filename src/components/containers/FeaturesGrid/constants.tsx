import FeatureIcon from "@/components/shared/FeatureIcon/FeatureIcon";

export const features = [
    {
      title: "APPOINTMENT",
      description: `Appointment with Datepicker allow you
      to collect all the information about your
      audience. Get closer to customers and
      discover who are they..`,
      icon: <FeatureIcon path="/appoinment.svg" />,
    },
    {
      title: "PRICING TABLES",
      description: `Outline your pricing policy with the help
    ...
    {
      title: "PARALLAX",
      description: `Feeling of true immersion, an illusion of
    ...
    {
      title: "SLIDER",
      description: `Great thing in terms of presenting
      important information. Place the slides
    ...
    {
      title: "MEGA MENU",
      description: `Powerful tool for creating a better look
      and professional navigation easily
      without technical knowledge. It allows
    ...
    {
      title: "GOOGLE MAP",
      description: `Show the whereabouts of your
      company using this interactive tool. It
    ...
    {
      title: "GOOGLE FONTS",
      description: `Your site won't be boring style on the
    ...
    },
    {
      ...
      description: `Change the palette of your site
      interface with only one click. This
    ...
    },
    {
      ...
      description: `A brief and functional search form
    ...
    {
      title: "CONTACT FORM",
      description: `By means of this built-in web form,
    ...
    {
      title: "UI ELEMENTS",
      description: `Easily add any type of content to your
    ...
    },
    {
      ...
      description: `Owing to the valid, semantic code your
    ...
    {
      title: "ONLINE CHAT",
      description: `Online chat allows you to communicate
    ...
    {
      title: "PORTFOLIO",
      description: `Showcase your works in the best
